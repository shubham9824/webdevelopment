...
function Test() {
    ...
    const [Submition, SetSubmition] = useState(initialState)
                    ...
                    <fieldset>
                        ...
                        <Form.Group>
                            ...
                            <Form.Control autoFocus={true} as="textarea" placeholder="Enter any fact's or about detail for your website."
                                rows={2} onChange={HandleChange} name="about" value={Submition.about} />
                            <div style={{ color: '#f50000' }} >{Submition.errors.about}</div>
                        </Form.Group>
                        <Form.Group>
                            <Form.Label>Email address</Form.Label>
                            <Form.Control type="text" onChange={HandleChange} name='email' placeholder="Enter email" />
                            <div style={{ color: '#f50000' }}>{Submition.errors.email}</div>
                        </Form.Group>
                        <Form.Group>
                            <Form.Label>Our Mission</Form.Label>
                            <Form.Control as="textarea" placeholder="Enter your Mission." value={Submition.mission} rows={2} onChange={HandleChange} name="mission" />
                            <div style={{ color: '#f50000' }} >{Submition.errors.mission}</div>
                        </Form.Group>
                        <Form.Group>
                            <Form.Label>Our Vision</Form.Label>
                            <Form.Control as="textarea" placeholder="Enter your Vision." value={Submition.vision} rows={2} onChange={HandleChange} name="vision" />
